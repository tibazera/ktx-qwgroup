...
static void player_predict_think(func_t next_think, int think_index)
{
	self->client_think = next_think;
	self->client_nextthink = self->client_time + 0.1;
	self->client_thinkindex = think_index;
...
{
	self->s.v.frame = 113;
	player_predict_think((func_t)player_shot2, 2);
...
{
	self->s.v.frame = 114;
	player_predict_think((func_t)player_shot3, 3);
...
{
	self->s.v.frame = 115;
	player_predict_think((func_t)player_shot4, 4);
...
{
	self->s.v.frame = 116;
	player_predict_think((func_t)player_shot5, 5);
	self->s.v.weaponframe = 4;
}
...
{
	self->s.v.frame = 117;
	player_predict_think((func_t)player_shot6, 6);
...
void player_shot6(void)
{
	self->s.v.frame = 118;
	self->walkframe = 0;
	player_predict_think((func_t)player_run, 0);
...
{
	self->s.v.frame = 119;
	player_predict_think((func_t)player_axe2, 2);
...
{
	self->s.v.frame = 120;
	player_predict_think((func_t)player_axe3, 3);
...
{
	self->s.v.frame = 121;
	player_predict_think((func_t)player_axe4, 4);
...
{
	self->s.v.frame = 125;
	player_predict_think((func_t)player_axeb2, 2);
...
{
	self->s.v.frame = 126;
	player_predict_think((func_t)player_axeb3, 3);
...
{
	self->s.v.frame = 127;
	player_predict_think((func_t)player_axeb4, 4);
...
{
	self->s.v.frame = 131;
	player_predict_think((func_t)player_axec2, 2);
...
{
	self->s.v.frame = 132;
	player_predict_think((func_t)player_axec3, 3);
...
{
	self->s.v.frame = 133;
	player_predict_think((func_t)player_axec4, 4);
...
{
	self->s.v.frame = 137;
	player_predict_think((func_t)player_axed2, 2);
...
{
	self->s.v.frame = 138;
	player_predict_think((func_t)player_axed3, 3);
...
{
	self->s.v.frame = 139;
	player_predict_think((func_t)player_axed4, 4);
...
{
	self->s.v.frame = 103;
	player_predict_think((func_t)player_nail2, 2);
...
{
	self->s.v.frame = 104;
	player_predict_think((func_t)player_nail1, 1);
...
{
	self->s.v.frame = 105;
	player_predict_think((func_t)player_light2, 1);
...
{
	self->s.v.frame = 106;
	player_predict_think((func_t)player_light1, 1);
...
{
	self->s.v.frame = 107;
	player_predict_think((func_t)player_rocket2, 2);
...
{
	self->s.v.frame = 108;
	player_predict_think((func_t)player_rocket3, 3);
...
{
	self->s.v.frame = 109;
	player_predict_think((func_t)player_rocket4, 4);
...
{
	self->s.v.frame = 110;
	player_predict_think((func_t)player_rocket5, 5);
...
{
	self->s.v.frame = 111;
	player_predict_think((func_t)player_rocket6, 6);
